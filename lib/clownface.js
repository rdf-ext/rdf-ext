...
var init = function (rdf) {
  ...
  cf.Graph = function (graph, nodes) {
    ...
    this.node = function (value) {
      return new cf.Graph(graph, value);
    };

    this.in = function (predicate) {
      return new cf.Graph(graph, match(null, predicate, nodes, 'subject'));
    };

    this.out = function (predicate) {
      return new cf.Graph(graph, match(nodes, predicate, null, 'object'));
    };
