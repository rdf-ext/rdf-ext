...
var serializePromiseWrapper = function (p, serialize) {
  return funcTemplate(function (args, callback) { serialize(args[0], callback) }, p);
};
...
module.exports = function (rdf) {
  ...
  rdf.promise.serialize = serializePromiseWrapper.bind(null, rdf.Promise);
};
